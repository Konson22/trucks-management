...
import { DateSearch, Searchbar, SelectSearch } from "../components/Searchbar"
...
export default function Dashboard() {
  ...
  return (
    <div className='app-container px-[1.5%]'>
      <div className="flex items-center justify-between my-6 md:mx-3">
        <div className="">
          <h1 className="md:block hidden text-2xl">TRUCKS REGISTERATION LOG</h1>
        </div>
        <div className="flex">
          {(profile.org === 'VSS' || profile.org === 'WLC') && <SelectSearch  handleSelectSearch={handleSelectSearch} />}
          <DateSearch setSelectedDate={handleSearchByDate} />
          <div className="md:block hidden">
            <Searchbar handleSearch={handleSearch} profile={profile} />
          </div>
        </div>
      </div>
...
function TruckTableData({data, profile, message}) {
  ...
  return (
    <>
    <table className="md:hidden blcok w-full">
