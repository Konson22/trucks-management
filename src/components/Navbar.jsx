...
export default function Navbar() {
    ...
    const { notifications, setNotifications } = useRecordsContext()
    ...
    return (
      <div className='md:h-[4.5rem] h-[4rem] bg-gray-700 text-white flex items-center justify-between md:px-[3%] px-2'>
        ...
        <div className="flex items-center">
          ...
          <div className="md:ml-6 ml-4 relative" onClick={toggleNotificationBar}>
            ...
            {(openNotification) && 
            <div className={`${notifications.length > 0 ? 'text-gray-500 w-max border-2 mt-2 absolute top-full right-0 rounded' : ''}`}>
